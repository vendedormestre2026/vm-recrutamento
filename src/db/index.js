...
module.exports = {
  ...
  excluirVaga: driver.excluirVaga,
  ...
  listarStatusRecrutadorParaElegibilidade: driver.listarStatusRecrutadorParaElegibilidade,
  listarTelefonesPorEmailParaElegibilidade: driver.listarTelefonesPorEmailParaElegibilidade,
  marcarEnvioCampanhaCanceladoPorStatus: driver.marcarEnvioCampanhaCanceladoPorStatus,
  ERRO_STATUS_NAO_ELEGIVEL: driver.ERRO_STATUS_NAO_ELEGIVEL,
