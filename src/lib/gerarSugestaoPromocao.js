...
function montarMensagensSugestao(vaga) {
  ...
  const system = [
    ...
    '- Termine convidando a pessoa a se candidatar. NAO escreva a URL da vaga, NAO escreva',
    '  "clique aqui" e NAO descreva um botao: logo apos o seu texto o sistema anexa um',
    '  paragrafo proprio com o link ("Ver a vaga e me candidatar"). Escreva a frase final',
    '  de modo que ela FLUA com esse link vindo em seguida — um convite ("se fizer sentido',
    '  para voce, veja os detalhes da vaga") funciona; uma frase que se refira a um link',
    '  que voce mesmo nao escreveu ("acesse o endereco abaixo agora") fica truncada.',
    '',
